...
module simpleAdder_DW01_add_0 ( A, B, CI, SUM, CO );
  input [32:0] A;
  input [32:0] B;
  output [32:0] SUM;
  input CI;
...
module simpleAdder ( a, b, cin, result, cout, overflow );
  ...
  simpleAdder_DW01_add_0 add_1_root_add_10_2 ( .A({1'b0, a}), .B({1'b0, b}), 
        .CI(cin), .SUM({cout, result}) );
  NOR2X0 U6 ( .IN1(n5), .IN2(n6), .QN(overflow) );
  XOR2X1 U7 ( .IN1(b[31]), .IN2(a[31]), .Q(n6) );
  XNOR2X1 U8 ( .IN1(a[31]), .IN2(result[31]), .Q(n5) );
endmodule
