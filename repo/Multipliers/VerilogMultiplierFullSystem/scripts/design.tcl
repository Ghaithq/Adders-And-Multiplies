...
read_file -format verilog  ../source/simpleMultiplier.v
...
write -hierarchy -format verilog -output ../results/Synth_simpleMultiplier.v
# Generate SDF file
set sdf_file_path "../results/simpleMultiplier.sdf"
