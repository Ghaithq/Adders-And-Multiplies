...
set_app_var search_path "/home/standard_cell_libraries/NangateOpenCellLibrary_PDKv1_3_v2010_12/lib/Front_End/Liberty/NLDM \
			 /home/mohamed/Desktop/FPAdderRouting/rtl"
...
import_designs  ../syn/results/${design}.v \
                -format verilog \
		-top ${design} \
		-cel ${design}

source  ../syn/source/MultTree.sdc
...
create_floorplan -core_utilization 0.6 \
	...
	-left_io2core 25 -bottom_io2core 25 -right_io2core 25 -top_io2core 25
...
preroute_standard_cells -nets VDD -connect vertical
preroute_standard_cells -nets VSS -connect vertical
...
report_area -hierarchy > output/synth_area.rpt
report_cell > output/synth_cells.rpt
report_qor  > output/synth_qor.rpt
report_power -hierarchy > output/total_power.rpt
report_resources > output/synth_resources.rpt
report_timing -max_paths 10 > output/synth_timing.rpt 
report_timing -delay min -max_paths 5 > output/synth_timing_min.rpt 
write_sdf FPAdder_SDF
